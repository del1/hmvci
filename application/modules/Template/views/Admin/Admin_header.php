...
<head>
  ...
  <title>Admin | Impression Bridal Dashboard</title>
  ...
  <!--[if lt IE 8]>
    ...
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center site-gridmenu- toggle" data-toggle="gridmenu">
        <img class="navbar-brand-logo" src="<?php echo base_url('assets/admin/images/logo.png');?>" title="Impression Bridal">
        <span class="navbar-brand-text hidden-xs-down"> Impression Bridal</span>
      </div>
